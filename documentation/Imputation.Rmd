...
- [Joseph L. Schafer](http://sites.stat.psu.edu/~jls/) seminal monograph
  ...
  Hall, London. [@schaffer1997analysis]
...
- Find data sets that are historically relevant:
    ...
    * Use the data sets in the appendix of [@schafer1997analysis]
    * Use the synthetic bivariate set of [@schafer2002missing]
    * Data sets: titanic, iris, mtcars.
